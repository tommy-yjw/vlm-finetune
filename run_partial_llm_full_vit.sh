...
export OUTPUT_DIR="./output/qwen_partial_llm_full_vit"
...
deepspeed --num_gpus=${NUM_GPUS} train.py \
    ...
    ${RESUME_FLAG} \
    \
    --tuning_strategy "partial_llm_full_vit" \
    --llm_frozen_layers 20 \
    \
    ...
    --eval_steps 250 \
    \
    --use_wandb --wandb_project "qwen-vl-finetune" --wandb_run_name "partial-llm-full-vit-run" \
    --log_to_file